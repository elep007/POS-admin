...
Route::get('/', 'CachierController@index');
Route::get('getProducts', 'CachierController@getProducts');
Route::get('submit', 'CachierController@submit');
Route::get('getOrders', 'CachierController@getOrders');
Route::get('getBillPrice', 'CachierController@getBillPrice');
...
Route::post('getGroups', 'OEEController@getGroups');
Route::post('factoryHealthy', 'OEEController@factoryHealthy');
Route::post('getLineHealthy', 'OEEController@getLineHealthy');


Route::get('/forgot_password', 'UserManagementController@forgot_password');
Route::post('/forgot_password', 'UserManagementController@post_forgot_password');
