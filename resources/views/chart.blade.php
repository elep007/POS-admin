            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <!-- Example Multi Balue -->
                        <div class="example-wrap">
                            <h4 class="example-title">Multi-Value</h4>
                ...
                <div class="row row-lg">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>You can also show the tick icon on single <code>select</code> with
                                the <code>show-tick</code> class:</p>
                            <div class="example">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker" data-style="btn-primary">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker" data-style="btn-info">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker" data-style="btn-success">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker" data-style="btn-warning">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker" data-style="btn-danger">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>Using the <code>data-selected-text-format</code> attribute on a
                                <code>multiple select</code> you can specify how the selection
                                is displayed.</p>
                            <div class="example">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>Add <code>data-divider="true"</code> to an option to turn it into
                                a divider.</p>
                            <div class="example">
                                <select data-plugin="selectpicker">
                                    <option>Mustard</option>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <select data-plugin="selectpicker">
                                    <option data-icon="md-case">Mustard</option>
                                    <option data-icon="md-favorite">Ketchup</option>
                                    <option data-icon="md-tv-play">Relish</option>
                                    <option data-icon="md-home">Mayonnaise</option>
                                    <option data-icon="md-print">Barbecue Sauce</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="form-group has-success">
                                    <label class="control-label" for="inputTokenfieldSuccess">Input with success</label>
                                    <input type="text" class="form-control" id="inputTokenfieldSuccess" data-plugin="tokenfield"
                                           value="red,green,blue" />
                                </div>
                                <div class="form-group has-warning">
                                    <label class="control-label" for="inputTokenfieldWarning">Input with warning</label>
                                    <input type="text" class="form-control" id="inputTokenfieldWarning" data-plugin="tokenfield"
                                           value="red,green,blue">
                                </div>
                                <div class="form-group has-error">
                                    <label class="control-label" for="inputTokenfieldError">Input with error</label>
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tags Input
                    <small><a class="example-plugin-link" href="http://timschlechter.github.io/bootstrap-tagsinput/examples/"
                              target="_blank">official website</a></small>
                </h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>Instead of just adding strings as tags, bind objects to your tags.
                                This makes it possible to set id values in your input field's
                                value, instead of just the tag's text. </p>
                            <div class="example">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example-buttons">
                                <button class="btn btn-primary" id="buttonSelectAll" type="button">select all</button>
                                <button class="btn btn-primary" id="buttonDeselectAll" type="button">deselect all</button>
                                <button class="btn btn-primary" id="buttonAdd" type="button">add some</button>
                                <button class="btn btn-primary" id="buttonRefresh" type="button">refresh</button>
                            </div>
                        </div>
            ...
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <small><a class="example-plugin-link" href="http://twitter.github.com/typeahead.js"
                              target="_blank">official website</a></small>
                    <span class="panel-desc">The typeahead autocomplete plugin for Twitter's Bootstrap 3 base on
              Twitter's typeahead.js.</span>
                </h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                ...
                                <input type="text" class="form-control" name="touchSpinPostfix" data-plugin="TouchSpin"
                                       ...
                                       data-boostat="5" data-maxboostedstep="10" data-postfix="%" value="55"
                                />
                            </div>
                            <div class="example">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Icheck
                    <small><a class="example-plugin-link" href="http://fronteed.com/iCheck" target="_blank">official website</a></small>
                </h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                            ...
                            <ul class="list-unstyled example">
                                ...
                                <li class="margin-bottom-15">
                                    <input type="radio" class="icheckbox-primary" id="inputRadiosDisabledUnchecked"
                                           name="inputRadiosDisabledUnchecked" data-plugin="iCheck" data-radio-class="iradio_flat-blue"
                                           disabled />
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap margin-sm-0">
                            ...
                            <ul class="list-unstyled list-inline example">
                                ...
                                <li class="margin-right-25 margin-bottom-25">
                                    <input type="checkbox" data-plugin="switchery" data-color="#757575" checked />
                                </li>
                                <li class="margin-right-25 margin-bottom-25">
                                    <input type="checkbox" data-plugin="switchery" data-color="#00897b" checked />
                                </li>
                                <li class="margin-right-25 margin-bottom-25">
                                    <input type="checkbox" data-plugin="switchery" data-color="#fb8c00" checked />
                                </li>
                                <li class="margin-right-25 margin-bottom-25">
                                    <input type="checkbox" class="js-switch-secondary" data-plugin="switchery" data-color="#e53935"
                                           checked />
                                </li>
                                <li class="margin-right-25 margin-bottom-25">
                                    <input type="checkbox" data-plugin="switchery" data-color="#8e24aa" checked />
                                </li>
                            </ul>
                        </div>
                        <!-- End Example Colors -->
                ...
                <div class="row row-lg">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>Add <code>data-plugin="datepicker"</code> to create a default datepicker.
                                use <code>data-multidate="true"</code> to selecting multi dates.</p>
                            <div class="example">
                                <div class="input-group">
                    <span class="input-group-addon">
                ...
                <div class="row row-lg">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>Add <code>data-mode="gradient"</code> ,then,you can generate CSS3
                                gradient by the mode.</p>
                            <div class="example">
                                <input type="text" class="asColorpicker form-control" data-plugin="asColorPicker"
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <p>Use <code>data-plugin="asRange"</code> to make a default slider range.Add
                            <code>data-range="true"</code>, <code>data-tip=true</code>, ...to
                            change mode or add tooltip... </p>
                        <!-- Example Default -->
                        <div class="example-wrap">
                            <h4 class="example-title">Default</h4>
                            <div class="example">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example margin-top-30">
                                <div class="asRange" data-plugin="asRange" data-namespace="rangeUi" data-step="1"
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="example-wrap">
                            <form class="example">
                                <div class="form-group">
                                    <label class="control-label margin-bottom-15" for="inputPassword1">Password</label>
                ...
                <div class="row text-center">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <input type="text" class="knob-chart knob-example-3" data-plugin="knob" data-line-cap="round"
                                       data-fg-color="#1e88e5" data-cursor="true" value="-25" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <input type="text" class="knob-chart knob-example-1" data-plugin="knob" data-fg-color="#e53935"
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <input type="text" class="knob-chart knob-example-2" data-plugin="knob" data-min="-15000"
                                       ...
                                       data-fg-color="#8e24aa" value="-10000" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <input type="text" class="knob-chart knob-example-6" data-plugin="knob" data-angleOffset="90"
                                       data-linecap="round" data-min="0" data-max="100" data-fg-color="#00acc1"
                                       value="60" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <input type="text" class="knob-chart knob-example-4" data-plugin="knob" data-fg-color="#00897b"
                ...
                <div class="panel">
                    <header class="panel-heading">
                        <h3 class="panel-title">Card
                            <small><a class="example-plugin-link" href="https://github.com/jessepollak/card"
                                      target="_blank">official website</a></small>
                        </h3>
                    </header>
                    <div class="panel-body container-fluid">
                        <p class="margin-bottom-35">Use <code>data-plugin="card"</code> ,<code>data-target="#card-container"</code>                to make it.</p>
                        <div class="row">
