                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="example-wrap margin-bottom-5">
                        ...
                        <div class="example text-center margin-0">
                            <canvas id="exampleChartjsBar" height="50" width="200"></canvas>
                        </div>
                    </div>
                    <!-- End Example Bar -->
                </div>

                <div class="col-md-4 col-sm-4 text-center text-bottom" style="margin-top: 150px">
                        ...
                        data.results.map((item) => {
                            ...
                            switch (item.status) {
                                case "Open":
                                    ...
                                    out += '<span class="block black font-size-13">Downtime</span>';
                                    break;
                                case "WIP":
                                    out += '<div class="arrival_circle">'+ item.machine_name +'</div>';
                                    out += '<div style="float: left">';
                                    out += '<span class="block black font-size-13">Arrival</span>';
                                    break;
                                case "Pause":
                                    out += '<div class="paused_circle">'+ item.machine_name +'</div>';
                                    out += '<div style="float: left">';
                                    out += '<span class="block black font-size-13">Paused</span>';
                                    break;

                                case "Resume":
                                    out += '<div class="normal_circle">'+ item.machine_name +'</div>';
                                    out += '<div style="float: left">';
                                    out += '<span class="block black font-size-13">Resume</span>';
                                    break;

                                case "Resolved":
                                    out += '<div class="normal_circle">'+ item.machine_name +'</div>';
                                    out += '<div style="float: left">';
                                    out += '<span class="block black font-size-13">Resolved</span>';
                                    break;

                                default:
                                    out += '<div class="normal_circle">'+ item.machine_name +'</div>';
                                    out += '<div style="float: left">';
                                    out += '<span class="block black font-size-13">Pending</span>';

                            }
                            out += '<span class="block black font-size-13">MTTR:'+ item.mttr +'</span>';
                            out += '<span class="block black font-size-13">AT: '+ item.at +'</span>';
                            out += '<span class="block black font-size-13">SLT: '+ item.slt +'</span>';
                            out += '</div>';
                            out += '</div>';
                            out += '</div>';
                            out += '</div>';
